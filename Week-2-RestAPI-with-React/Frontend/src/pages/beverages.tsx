...
const beverages: Beverage[] = [
  ...
  },
  {
    ...
    image: "https://www.cuisinart.com/dw/image/v2/ABAF_PRD/on/demandware.static/-/Sites-us-cuisinart-sfra-Library/default/dw30047d66/images/recipe-Images/cappuccino1-recipe.jpg?sw=1200&sh=1200&sm=fit",
    availableSizes: ["small", "medium", "large"],
  ...
  },
  {
    ...
    image: "https://iel.co.th/wp-content/uploads/2025/07/%E0%B8%8A%E0%B8%B2%E0%B9%84%E0%B8%97%E0%B8%A2%E0%B9%84%E0%B8%A1%E0%B9%88%E0%B9%83%E0%B8%AA%E0%B9%88%E0%B8%AA%E0%B8%B5-3_0-1024x1024.jpg",
    availableSizes: ["small", "medium", "large"],
    availableTypes: ["hot", "iced"],
    customizable: {
      sweetness: true,
  ...
  },
  {
    ...
    basePrice: 80,
    category: "coffee",
    description: "มอคค่าเย็น หอมหวานกลมกล่อม",
    image: "https://www.intheraw.com/wp-content/uploads/2019/01/Iced_Mocha_630x420.jpg",
    availableSizes: ["small", "medium", "large"],
    availableTypes: ["iced"],
    customizable: {
      sweetness: true,
  ...
  },
  {
    ...
    basePrice: 95,
    category: "other",
    description: "โอรีโอปั่น หวานมัน อร่อยลงตัว",
    image: "https://i.ytimg.com/vi/xclqn78eoFU/maxresdefault.jpg",
  ...
  },
  {
    ...
    basePrice: 70,
    category: "other",
    description: "โกโก้เข้มข้น หอมหวาน",
    image: "https://www.falconforprofessional.com/wp-content/uploads/2023/10/91.jpg",
    availableSizes: ["small", "medium", "large"],
    availableTypes: ["hot", "iced"],
    customizable: {
      sweetness: true,
  ...
  },
  {
    ...
    basePrice: 65,
    category: "other",
    description: "โอวัลติน หอมหวาน อร่อย",
    image: "https://media-cdn.tripadvisor.com/media/photo-s/0f/08/4e/f3/iced-oldschool-ovaltine.jpg",
    availableSizes: ["small", "medium", "large"],
    availableTypes: ["hot", "iced"],
    customizable: {
      sweetness: true,
  ...
  },
  {
    ...
    basePrice: 60,
    category: "tea",
    description: "ชามะนาว เปรี้ยวหวาน สดชื่น",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRR3isaXIp_yAO_zdSYVnilMi_XrXyA9aKnbw&s",
    availableSizes: ["small", "medium", "large"],
    availableTypes: ["iced"],
    customizable: {
      sweetness: true,
  ...
  },
  {
    ...
    basePrice: 50,
    category: "other",
    description: "น้ำแดงมะนาวโซดา เปรี้ยวหวานซ่า สดชื่น",
    image: "https://as1.ftcdn.net/jpg/02/77/19/58/1000_F_277195888_qicuOsOqXaiabqQVxHoveszJq7Sni77O.jpg",
    availableSizes: ["small", "medium", "large"],
    availableTypes: ["iced"],
    customizable: {
      sweetness: true,
  ...
  },
  {
    ...
    basePrice: 65,
    category: "other",
    description: "นมสด หวานมัน อร่อย",
    image: "https://app-cciyo.com/images/product/1/390_1.jpg",
    availableSizes: ["small", "medium", "large"],
    availableTypes: ["iced"],
    customizable: {
      sweetness: true,
  ...
  },
  {
    ...
    basePrice: 70,
    category: "other",
    description: "สตรอว์เบอร์รี่นมสด หวานหอม อร่อย",
    image: "https://www.resplendentkitchen.com/wp-content/uploads/2022/09/Strawberry-Milk01257_EMILY-MILLER-1.jpg",
    availableSizes: ["small", "medium", "large"],
    availableTypes: ["frappe"],
    customizable: {
      sweetness: true,
